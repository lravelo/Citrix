...
c:\temp\VDAServerSetup_1912.exe /controllers "DDCFQDN1 DDCFQDN2 DDCFQDN3" /noreboot /quiet /enable_remote_assistance /disableexperiencemetrics /enable_framehawk_port /enable_hdx_ports /enable_hdx_udp_ports /exclude "AppDisks VDA Plug-in","Citrix Files for Outlook","Citrix Files for Windows","Citrix Personalization for App-V - VDA","Personal vDisk" /COMPONENTS VDA
...
del c:\temp\VDAServerSetup_1912.exe /F
